...
OUTPUT_DIR = ROOT_DIR / "hybrid_smallest_figures_benchmark"
...
# ============================================================
# Benchmark configuration (hybrid solver with smallest figures)
# ============================================================
...
def build_summary_text(run_rows: List[Dict[str, Any]], iteration_rows: List[Dict[str, Any]]) -> str:
    ...
    lines: List[str] = []
    lines.append("smallest-figures hybrid benchmark summary")
