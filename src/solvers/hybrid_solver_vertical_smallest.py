...
class HybridSolver:
    ...
    def solve(
        ...
        *,
        ...
        effective_sample_size = len(smallest_pool_ids)
        _hybrid_log(
            (
                "sampling config: strategy=smallest_area, "
                f"sample_size={sample_size}, selected={effective_sample_size}, "
                f"iterations={random_iterations}, seed_ignored={random_seed is not None}, "
        ...
        for iter_idx in range(random_iterations):
            sampled_item_ids: Set[object] = set(smallest_pool_ids)
        ...
        if not improved:
            ...
            return {
                ...
                "hybrid_stats": {
                    ...
                    "random_sample_size": int(effective_sample_size),
