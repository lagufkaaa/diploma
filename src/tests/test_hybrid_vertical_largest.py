...
def test_hybrid_vertical_largest_basic():
    ...
    print(f"hybrid-vertical-largest input file: {file_path}")
    print("starting data")
    ...
    print("starting hybrid-vertical-largest")
    ...
    print("--- hybrid-vertical-largest solve results ---")
    print(
        {
    ...
    assert status in {"OK", "NOT_IMPROVED", "NOT_PROVEN"}, (
        f"Unexpected hybrid-vertical-largest status: {status}"
    )
    ...
    assert stats.get("sampling_strategy") == "largest_area"
